package com.fyp.hongqiaoservice.dynamic;
...
import com.fyp.hongqiaoservice.dynamic.flight.DynamicFlightFragment;
import com.fyp.hongqiaoservice.dynamic.train.DynamicTrainFragment;
...
public  class DynamicFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //viewPager
        ViewPager mViewPager = (ViewPager) rootView.findViewById(R.id.viewpager_dynamic);
        mViewPager.setAdapter(new MyPagerAdapter(getActivity().getSupportFragmentManager()));
        mViewPager.setOffscreenPageLimit(3);//预加载页数
        PagerSlidingTabStrip mPagerSlidingTabStrip = (PagerSlidingTabStrip) rootView.findViewById(R.id.tabs_dynamic);
    ...
    private class MyPagerAdapter extends FragmentStatePagerAdapter {
        ...
        private final String[] TITLES = { "高铁", "航班"};
        ...
        public Fragment getItem(int position) {
            ...
            switch (pattern) {
                case 0:
                default: {
                    return new DynamicTrainFragment();

                }
                case 1:{

                    return new DynamicFlightFragment();
                }
