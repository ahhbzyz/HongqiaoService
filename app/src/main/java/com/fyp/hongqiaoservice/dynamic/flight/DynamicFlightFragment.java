package com.fyp.hongqiaoservice.dynamic.flight;
 ...
 */
public class DynamicFlightFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_dynamic_flight, container, false);
        ...
        URL = Constant.URL+Constant.FlightQueryServlet +"type=dynamic";
                            ...
                            public void execute(String response)
                            {
                                ...
                                if(f1DynFlightList!=null) {
                                    ...
                                    if(isJSON){
                                        ...
                                        adapter = new FlightResultsAdapter(f1DynFlightList, getActivity());
                                        msg.what=0;
        ...
        public boolean handleMessage (Message msg) {
            switch(msg.what) {
                case 0:
                    ...
                    break;
                case 1:
                    Toast.makeText(getActivity(), "很抱歉，暂时没有符合您条件的航班", Toast.LENGTH_SHORT).show();
                    break;
                case 2:
